...
- Rule: If the `user_prompt` is 6 characters or less, it MUST be classified as this type.
- Query IDs:
...
# --- API 호출 함수 ---
async def call_gemini_api(prompt: str, model_name: str = 'gemini-2.5-flash-lite-preview-06-17') -> str | None:
    ...
    generation_config = {
        ...
        # top_p와 top_k는 설정하지 않아 기본값을 사용합니다.
    }
